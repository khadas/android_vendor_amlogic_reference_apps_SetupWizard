...
public final class WifiConfigHelper {
     ...
     */
    public static WifiConfiguration getConfiguration(Context context, String ssid, int security, String password) {
        ...
        if (config == null) {
            ...
            setConfigKeyManagementBySecurity(config, security, password);
        }
        return config;
    }
